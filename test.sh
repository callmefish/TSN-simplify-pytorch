...
gsutil cp gs://ucf101_for_rar/sample_video.zip /TSN-simplify-pytorch/
cd $REPO
unzip sample_video.zip
gsutil cp gs://ucf101_for_rar/475_inceptionv4__flow_model_best.pth.tar /TSN-simplify-pytorch/
gsutil cp gs://ucf101_for_rar/475_inceptionv4_rgb_model_best.pth.tar /TSN-simplify-pytorch/
