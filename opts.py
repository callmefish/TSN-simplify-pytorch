...
parser.add_argument('--train_list', type=str, default='/home/yzy20161103/tsn-pytorch-master/train_list.txt')
parser.add_argument('--val_list', type=str, default='/home/yzy20161103/tsn-pytorch-master/test_list.txt')
...
parser.add_argument('--snapshot_pref', type=str, default="475_bninception_")
